 ...
 * Core fields mirror a standard business directory listing; tenants can enable/require each via UI.
 */
...
/** Default field configuration for new tenants who enable the directory. */
