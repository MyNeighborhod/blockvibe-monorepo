      ...
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="max-w-2xl mx-auto text-lg text-slate-600 dark:text-slate-400">
            Become an annual paying member, renew your current membership, or make a one-time donation to keep our community vibrant.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 border border-slate-200 dark:border-slate-700 shadow-xl flex flex-col justify-between transform hover:-translate-y-1 transition-all">
            <div>
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400 mb-6">
                Join as an Individual ($100/yr) or Household ($150/yr) to support local projects and gain voting privileges.
              </p>
            </div>
            <Link
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 border border-slate-200 dark:border-slate-700 shadow-xl flex flex-col justify-between transform hover:-translate-y-1 transition-all">
            <div>
              ...
              <p className="text-sm text-slate-600 dark:text-slate-400 mb-6">
                Make a custom one-time contribution of any amount to support neighborhood events and initiatives.
              </p>
            </div>
            <Link
