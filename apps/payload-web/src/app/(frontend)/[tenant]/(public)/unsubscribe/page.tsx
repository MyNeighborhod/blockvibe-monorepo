        ...
        <CardContent className="space-y-4 px-8">
          ...
          {!loading && success && (
            <p className="text-sm text-muted-foreground leading-relaxed">
              Your email <strong className="text-foreground">{email}</strong> has been removed from our active announcement list. If this was a mistake, please contact your association administrator to opt back in.
            </p>
          )}
          {!loading && error && (
