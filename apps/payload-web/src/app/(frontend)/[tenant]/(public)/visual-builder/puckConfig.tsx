...
export function getPuckConfig(tenantSlug: string = "nog"): PuckConfig {
  return {
    components: {
      HeroSection: {
        fields: {
        ...
        fields: {
          ...
          col1ImageUrl: {
            ...
            render: ({ value, onChange }) => (
              <MediaPickerField value={value} onChange={onChange} label="Column 1 Image" tenantSlug={tenantSlug} />
            ),
          },
          ...
          col2ImageUrl: {
            type: "custom",
            render: ({ value, onChange }) => (
              <MediaPickerField value={value} onChange={onChange} label="Column 2 Image" tenantSlug={tenantSlug} />
            ),
          },
          ...
          col3ImageUrl: {
            type: "custom",
            render: ({ value, onChange }) => (
              <MediaPickerField value={value} onChange={onChange} label="Column 3 Image" tenantSlug={tenantSlug} />
            ),
          },
      ...
      MediaSection: {
        fields: {
          ...
          imageUrl: {
            type: "custom",
            render: ({ value, onChange }) => (
              <MediaPickerField value={value} onChange={onChange} label="Section Image" tenantSlug={tenantSlug} />
            ),
          },
          caption: { type: "text" },
        },
...
export const puckConfig = getPuckConfig("nog")
